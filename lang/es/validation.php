...
|--------------------------------------------------------------------------
|
| Mensajes por defecto para todas las reglas de validación de Laravel.
| :attribute, :other, :value, etc. se reemplazan en tiempo de ejecución.
| Personaliza un mensaje puntual en 'custom'; renombra un campo en 'attributes'.
|
*/
...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute proporcionado apareció en una filtración de datos. Elige un :attribute diferente.',
    ],
    ...
    |--------------------------------------------------------------------------
    | Usa la convención "campo.regla" para sobrescribir un mensaje puntual.
    */
    'custom' => [
        'tipo_tramite' => [
            'required' => 'Debes seleccionar el tipo de trámite.',
            'in' => 'El tipo de trámite debe ser Depósito o Donación.',
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    | Reemplaza :attribute por un nombre legible. Laravel ya convierte
    | snake_case a palabras; agrega aquí solo los que necesiten otro texto.
    */
    'attributes' => [
        'tipo_tramite' => 'tipo de trámite',
        'entidad_depositante_id' => 'entidad depositante',
