...
/**
 * Identificador de valor (UUID v4) de una
 ...
 */
final readonly class SolicitudProrrogaId
{
    ...
    public static function fromString(string $value): self
    {
        if (! preg_match('/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i', $value)) {
            throw new InvalidArgumentException("Valor inválido para SolicitudProrrogaId: '{$value}'");
        }
