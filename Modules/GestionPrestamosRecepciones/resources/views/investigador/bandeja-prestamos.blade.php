                            ...
                            <td class="px-4 py-3">
                                @if($prestamo->estado === 'en_transito')
                                    <flux:button size="sm" variant="primary" icon="clipboard-document-check"
                                        wire:navigate href="{{ route('prestamos.investigador.prestamo.verificacion-entrega', $prestamo->prestamoId) }}">
                                        Reportar recepción
                                    </flux:button>
                                @else
                                    <flux:button size="sm" variant="ghost" icon="eye"
                                        wire:navigate href="{{ route('prestamos.investigador.prestamo.detalle', $prestamo->prestamoId) }}">
                                        Ver
                                    </flux:button>
                                @endif
                            </td>
