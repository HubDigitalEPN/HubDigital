...
<head>
    ...
    <title>Acción correctiva requerida</title>
</head>
...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;background-color:#ffffff;border-radius:10px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
    ...
    <tr>
        <td style="background-color:#FDECEA;padding:14px 40px;border-left:4px solid #D32F2F;">
            <p style="margin:0;font-size:14px;color:#B71C1C;font-weight:600;">
                La recepción de tu lote fue suspendida por: {{ $motivoFallo }}
            </p>
        </td>
    </tr>
    ...
    <tr>
        <td style="padding:28px 40px;">
            <p style="margin:0 0 16px;font-size:15px;color:#212121;line-height:1.6;">
                El curador detectó una anomalía subsanable en tu lote. Realiza la acción correctiva
                indicada y vuelve a presentar el mismo lote: tu Código QR sigue vigente para reintentar
                la recepción.
            </p>
            <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#F5F7FA;border-radius:8px;margin:0 0 24px;">
                <tr><td style="padding:16px 20px;text-align:center;">
                    <p style="margin:0 0 4px;font-size:11px;color:#757575;text-transform:uppercase;letter-spacing:1px;">Acción correctiva</p>
                    <p style="margin:0;font-size:20px;color:#1B365D;font-weight:700;">{{ $accionCorrectiva }}</p>
                </td></tr>
            </table>
            <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
                <tr><td style="border-radius:8px;background-color:#1B365D;">
                    <a href="{{ $url }}" style="display:inline-block;padding:12px 28px;font-size:14px;color:#ffffff;font-weight:600;text-decoration:none;">
                        Ver los detalles de mi solicitud
                    </a>
                </td></tr>
            </table>
        </td>
