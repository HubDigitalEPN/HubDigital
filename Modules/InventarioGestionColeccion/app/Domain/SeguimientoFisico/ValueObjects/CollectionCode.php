...
final readonly class CollectionCode
{
    ...
    public static function desde(string $value): self
    {
        ...
        if ($normalizado === '') {
            throw new \InvalidArgumentException('CollectionCode no puede estar vacío.');
        }

        if (mb_strlen($normalizado) > 120) {
            throw new \InvalidArgumentException('CollectionCode no puede exceder 120 caracteres.');
        }
