...
Característica: Alerta de orden taxonómico en la disposición de cajas
  ...
  para mantener la colección organizada según la secuencia de familias definida por el curador y, dentro de cada familia, alfabéticamente por subfamilia y género, sin bloquear el flujo de trabajo.
