...
Característica: Registro automático de ubicación de cajas
  ...
  Esquema del escenario: Registro de movimiento de una caja en el gabinete
    Dado que se está monitoreando el gabinete
    Y existe una caja entomológica en condición de <condicion_previa>
    Cuando <accion> la caja entomológica
  ...
  Escenario: Movimiento no autorizado fuera del horario establecido
    Dado que el horario autorizado de movimiento está configurado
