...
return [
    ...
    */
    ...
    'payload' => [
        // 5MB — Inventario/Taxonomia mantiene listados grandes (4k+ taxa, 48k
        // especímenes) en estado de componente. La paginación viene server-side
        // pero algunas pantallas serializan colecciones completas para selects
        // y dropdowns. Si esto se sigue inflando, refactor a Eager loading.
